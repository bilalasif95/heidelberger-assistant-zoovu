    ...
    <div :class="componentStyle.container" class="shown-products-table">
        <table>
                ...
                <th v-for="product in shownProducts">
                    <div :id="product.mid" class="product-header">
                        ...
                        <div class="product-image">
                            <component :is="productClickoutLinkView" v-bind:product="product" target="_blank">
                                <!-- <img :src="product.picture" :alt="product.name"> -->
                                <div class="product-custom-image"
                                    :style="{backgroundColor: product.picture}"></div>
                            </component>
                        </div>
            ...
            <template v-for="group in propertyGroups">
                <component :is="propertyGroupView" v-bind:group="group" v-bind:shownProducts="shownProducts"></component>
            </template>
        </table>
    </div>
</template>
